...
dataFiltered
  .filter(d => parseInt(d.securities_type_id, 10) === 2 && moment(d.trade_date).diff(moment(), 'day') === 0)
  .forEach((d, i) => {
    compiledData.push([
      {
        value: i + 1,
...
const sheet1 = [
  {
    ...
    data: [
      ...
      [
        {
          value: `Daftar seluruh transaksi Obligasi Korporasi Konvensional, Syariah dan Sukuk Korporasi serta EBA yang dilaporkan melalui BEI ${moment().format(
            'DD MMMM Y'
          )}`,
      ...
      [
        {
          value: `List of Corporate Securities Transaction Report ${moment().format('LL')}`,
  ...
  render() {
    return (
      <>
        ...
        <ExcelFile filename="All Corporate Transaction for Mass Media">
          <ExcelSheet dataSet={sheet1} name="All Corporate Transaction for Mass Media" />
        </ExcelFile>
      </>
    );
  }
