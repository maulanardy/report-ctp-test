...
dataFiltered
  .filter(d => parseInt(d.securities_type_id, 10) === 1 && moment(d.trade_date).diff(moment(), 'day') === 0)
  .forEach((d, i) => {
    compiledData.push([
      {
        value: i + 1,
...
const sheet1 = [
  {
    ...
    data: [
      ...
      [
        {
          value: `Daftar seluruh transaksi Surat Berharga Negara yang dilaporkan melalui BEI ${moment().format(
            'DD MMMM Y'
          )}`,
      ...
      [
        {
          value: `List of Government Securities Transaction Report ${moment().format('LL')}`,
  ...
  render() {
    return (
      <>
        ...
        <ExcelFile filename="All Government Transaction for Mass Media">
          <ExcelSheet dataSet={sheet1} name="All Government Transaction for Mass Media" />
        </ExcelFile>
      </>
    );
  }
